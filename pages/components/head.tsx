    ...
    <>
      <header>
        <Navbar
          fluid={true}
          rounded={true}
          className={`bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600 ${isNavbarOpen ? 'open' : ''}`}
        >
          <Link href="/">
            <img
              src="/logo.png"
          ...
          <Navbar.Collapse className={isNavbarOpen ? 'show' : ''}>
            <a
